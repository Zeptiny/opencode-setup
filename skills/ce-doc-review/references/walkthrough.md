...
Use the the `question` tool. The `question` tool is always available in OpenCode. Never silently skip the question. Rendering the routing question as narrative text without the numbered-list fallback is a bug.

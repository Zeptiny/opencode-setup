...
description: "Use when implementing a written plan with multiple independent tasks. Examples: implement this plan, execute plan, run the tasks, start implementation, begin coding."
---

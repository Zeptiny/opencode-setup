...
When asking the user a question, use the the `question` tool. Never silently skip the question.
...
After document review and final checks, present this menu using the the `question` tool. Never silently skip the question.
